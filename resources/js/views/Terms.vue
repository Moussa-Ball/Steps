<template>
  <div class="container">
    <div class="col-xs-12 mt-5 mb-5">
      ...
      <p>"Personal Information" means any information that may be used to identify an individual, including, but not limited to, a first and last name, a home or other physical address and an email address or other contact information, whether at work or at home. In general, you can visit all web pages without telling us who you are or revealing any Personal Information about yourself.</p>
      <br />
      ...
      <p>Third parties provide certain services available on www.toiljobs.com on Funds and Toil's behalf. 'Funds and Toils' may provide information, including Personal Information, that 'Funds and Toils' collects on the web to third-party service providers to help us deliver programs, products, information, and services. Service providers are also an important means by which 'Funds and Toils' maintains its websites and mailing lists. 'Funds and Toils' will take reasonable steps to ensure that these third-party service providers are obligated to protect Personal Information on Funds and Toils’s behalf.</p>
      <p>'Funds and Toils' does not intend to transfer Personal Information without your consent to third parties who are not bound to act on Funds and Toils's behalf unless such transfer is legally required. Similarly, it is against Funds and Toils's policy to sell Personal Information collected online without consent.</p>
      <br />
      <h4>Your Consent</h4>
      <p>By using this web site, you consent to the terms of our online Privacy Policy and to Funds and Toils's processing of Personal Information for the purposes given above as well as those explained where 'Funds and Toils' collects Personal Information on the web</p>
      <br />
      ...
      <p>• We restrict access to your personally identifying information to employees who need to know that information in order to operate, develop or improve our services</p>
      <br />
      ...
      <br />
      <h4>Children</h4>
      <p>'Funds and Toils' will not contact children under age 13 about special offers or for marketing purposes without a parent's permission</p>
      <br />
      <h4>Information Sharing and Disclosure</h4>
      <ul type="disc" class="privacy">
        <li>
          'Funds and Toils' does not rent, sell, or share personal information about you with other people (save with your consent) or non-affiliated companies except to provide products or services you've requested, when we have your permission, or under the following circumstances
          <ul type="circle" class="pricavy">
            <li>We provide the information to trusted partners who work on behalf of or with 'Funds and Toils' under confidentiality agreements. These companies may use your personal information to help 'Funds and Toils’ communicate with you about offers from 'Funds and Toils and our marketing partners. However, these companies do not have any independent right to share this information</li>
      ...
      <p>
        'Funds and Toils' welcomes your comments regarding this privacy statement at the contact address given at the website. Should there be any concerns about contravention of this Privacy Policy, 'Funds and Toils' will employ all commercially reasonable efforts to address the same.
